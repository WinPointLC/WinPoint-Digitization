...
import java.sql.Date;
	...
	private Date atualInstallment1Date;
	...
	public StudentCourseInstallmentDetails(Integer actualInstallment1, Date atualInstallment1Date, 
		...
		this.atualInstallment1Date = atualInstallment1Date;
	...
	public StudentCourseInstallmentDetails(Integer userId, Integer courseId, Integer plannedInstallment1,
			Date plannedInstallment1Date, Integer actualInstallment1, Date atualInstallment1Date,
			...
			Integer actualInstallment3, Date actualInstallment3Date, Integer duedate, Integer dueAmount) {
		super();
		this.userId = userId;
	...
	public Date getAtualInstallment1Date() {
		return atualInstallment1Date;
	}
	public void setAtualInstallment1Date(Date atualInstallment1Date) {
		this.atualInstallment1Date = atualInstallment1Date;
	}
