...
public class EvaluationScreenWrapperParent {
	...
	public EvaluationScreenWrapperParent(String firstName,String lastName,Integer userId,
	...
	public EvaluationScreenWrapperParent(String firstName,String lastName, String gradeId, String isCertificateGiven) {
		super();
		this.fullName =firstName + " " +lastName;
		this.gradeId = gradeId;
		this.isCertificateGiven = isCertificateGiven;
