...
document.getElementById('revenue-tracker-link').onclick=function() {
	if (document.getElementById('main-content').style.display === "block") {
	  ...
	  document.getElementById('AddNewQuestion-jsp').style.display="none";
	  //alert("Before JAVAFX");
	  dtjava.launch({url: 'UnsignedJNLP.jnlp'});
	  //var javafxScreen = document.getElementById("HelloJavaFx");
	  //alert(javafxScreen);
	  //javafxScreen.launch();
	  //alert("After JAVAFX");
	  /*$.ajax({
          type: 'POST',
          url: '/OnlineEvaluationSystem/CommonController',
          dataType: 'json',
          contentType: 'application/json; charset=utf-8',
          traditional: true,
          success: function (jsonObj) {
            alert("success in displaying JavaFX screen");
          },
          error: function(){
            alert("Error in displaying JavaFX screen");
          }
        });*/
	}
	};
